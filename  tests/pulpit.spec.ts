...
test.describe('Pulpit tests', () => {
    ...
    test('quick payment with correct data', async ({ page }) => {
        ...
        await page.locator('#widget_1_transfer_receiver').selectOption({ label: transferReceiver });
        ...
        // Assert
        await expect(page.locator('#show_messages')).toHaveText(`Przelew wykonany! ${transferReceiver} - ${transferAmount},00PLN - ${transferTitle}`);
    });
